package com.attinae.academicoapi.utility;
...
public class JWTTokenProvider {
    ...
    public String generateJwtToken(UserPrincipal userPrincipal) {
        ...
        return JWT.create().withIssuer(ATTINAE_LLC)
                .withAudience(ATTINAE_ADMINISTRATION)
    ...
    private String[] getClaimsFromToken(String token) {
        ...
        return jwtVerifier.verify(token).getClaim(AUTHORITIES)
    ...
    private JWTVerifier getJWTVerifier() {
        ...
        try {
            ...
            verifier = JWT.require(algorithm).withIssuer(ATTINAE_LLC).build();
